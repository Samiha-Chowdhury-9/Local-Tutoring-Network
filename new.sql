...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2026 at 07:07 PM
...
-- Database: `ltn`
--
CREATE DATABASE IF NOT EXISTS `ltn` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `ltn`;
...
('root', '[{\"db\":\"ltn\",\"table\":\"tutor_subjects\"},{\"db\":\"ltn\",\"table\":\"subjects\"},{\"db\":\"ltn\",\"table\":\"bookings\"},{\"db\":\"ltn\",\"table\":\"users\"}]');
...
('root', '2026-01-16 18:04:40', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":253}');
